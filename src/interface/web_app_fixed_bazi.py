#!/usr/bin/env python3
"""
Qianji Web Application - Fixed Bazi Calculation with Authoritative Tools
"""
import os
import sys
import json
...
from src.core.independent_qji_fixed_bazi import IndependentQjiFixedBaziEngine
...
print("正在加载千机AI模型（修复八字计算版）...")
ai_engine = IndependentQjiFixedBaziEngine()
print("千机AI模型加载完成！")
...
def chat():
    """Handle chat messages with real Qianji AI"""
    try:
        data = request.get_json()
        ...
        # Get response from real Qianji Engine  
